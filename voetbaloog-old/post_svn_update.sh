...
php $PRIVATEHTML/app_voetbaloog/model/installer/update.php

# shrink jslibs jslibrary and jslibraryvo
PUBLICHTML=/var/www/voetbaloog/pub_voetbaloog
YUIJAR=$PRIVATEHTML/ThirdParties/yuicompressor-2.4.8.jar
...
rm $PRIVATEHTML/app_voetbaloog/cache/*
